import { composeContext } from "@wowtelligence-org/wowtelligence/src/context.ts";
import { generateText } from "@wowtelligence-org/wowtelligence/src/generation.ts";
import { getGoals } from "@wowtelligence-org/wowtelligence/src/goals.ts";
import { parseJsonArrayFromText } from "@wowtelligence-org/wowtelligence/src/parsing.ts";
import {
    IAgentRuntime,
    Memory,
    ModelClass,
