...
export class DiscordClient extends EventEmitter {
    ...
    private async onClientReady(readyClient: { user: { tag: any; id: any } }) {
        wowtelligenceLogger.success(`Logged in as ${readyClient.user?.tag}`);
    ...
    async handleReactionAdd(reaction: MessageReaction, user: User) {
        wowtelligenceLogger.log("Reaction added");
        // if (user.bot) return;
...
export const DiscordClientInterface: WowtelligenceClient = {
