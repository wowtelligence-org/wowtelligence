...
export const wowtelligenceLogger = new WowtelligenceLogger();
wowtelligenceLogger.clear();
wowtelligenceLogger.closeByNewLine = true;
wowtelligenceLogger.useIcons = true;

export default wowtelligenceLogger;
